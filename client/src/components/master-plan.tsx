          ...
          <div className="lg:w-3/5 animate-fade-in">
            ...
            >
              <img
                ...
                className="w-full h-[650px] transition-transform duration-700 group-hover:scale-105"
              />
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 animate-fade-in">
              ...
              <div className="bg-secondary/30 p-4 rounded-md">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center">
                    <i className="fab fa-whatsapp text-primary mr-2 w-5"></i> +91 95381 82438
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-globe text-primary mr-2 w-5"></i>aetherbymythreyi.com
                  </li>
                </ul>
              </div>
            </div>
