      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex items-center space-x-2">
            <img src="/assets/logo.jpg" alt="Mythreyi Logo" className="h-10 w-auto" />

            <h1 className="text-3xl font-playfair font-bold text-white leading-tight">
              <span className="text-primary">AETHER</span>{' '}
              <span className="text-white text-[18px]">by Mythreyi</span>
            </h1>
          </div>
