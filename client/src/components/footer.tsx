      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-primary/10 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <a href="/terms" className="text-muted-foreground hover:text-primary transition-colors duration-300 text-sm">Terms & Conditions</a>
            <p className="text-muted-foreground text-sm">
              Designed by <a href="https://rightturn.co.in/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Rightturn E Design</a>
            </p>
          </div>
        </div>
      </div>
